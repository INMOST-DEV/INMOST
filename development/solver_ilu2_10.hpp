...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	bool Solve(Solver::Vector & input, Solver::Vector & output)
	{
		assert(&input != &output);
		//
		INMOST_DATA_ENUM_TYPE k, mobeg, moend, wbeg, wend, cbeg, cend, vbeg, vend,m;
		info->GetOverlapRegion(info->GetRank(), mobeg, moend);
		info->GetVectorRegion(vbeg, vend);
		...
		for (levels_t::iterator it = level_size.begin(); it != level_size.end(); ++it)
		{
			...
			for (k = cend; k < wend; ++k)
			{
				for (m = E_Address[it - level_size.begin()]->at(k).first; m < E_Address[it - level_size.begin()]->at(k).last; ++m)
