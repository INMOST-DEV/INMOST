...
#define TO_STRING
	...
	INMOST_DATA_REAL_TYPE Integrate(INMOST_DATA_REAL_TYPE input, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	INMOST_DATA_ENUM_TYPE Integrate(INMOST_DATA_ENUM_TYPE input, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	INMOST_DATA_INTEGER_TYPE Integrate(INMOST_DATA_INTEGER_TYPE input, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	void Integrate(INMOST_DATA_REAL_TYPE* input, INMOST_DATA_ENUM_TYPE size, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	void Integrate(INMOST_DATA_ENUM_TYPE* input, INMOST_DATA_ENUM_TYPE size, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	void Integrate(INMOST_DATA_INTEGER_TYPE* input, INMOST_DATA_ENUM_TYPE size, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	INMOST_DATA_INTEGER_TYPE ExclusiveSum(INMOST_DATA_INTEGER_TYPE input, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	INMOST_DATA_ENUM_TYPE ExclusiveSum(INMOST_DATA_ENUM_TYPE input, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	INMOST_DATA_REAL_TYPE AggregateMax(INMOST_DATA_REAL_TYPE input, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	INMOST_DATA_ENUM_TYPE AggregateMax(INMOST_DATA_ENUM_TYPE input, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	INMOST_DATA_INTEGER_TYPE AggregateMax(INMOST_DATA_INTEGER_TYPE input, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	void AggregateMax(INMOST_DATA_REAL_TYPE* input, INMOST_DATA_ENUM_TYPE size, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	void AggregateMax(INMOST_DATA_ENUM_TYPE* input, INMOST_DATA_ENUM_TYPE size, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	void AggregateMax(INMOST_DATA_INTEGER_TYPE* input, INMOST_DATA_ENUM_TYPE size, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	INMOST_DATA_REAL_TYPE AggregateMin(INMOST_DATA_REAL_TYPE input, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	INMOST_DATA_ENUM_TYPE AggregateMin(INMOST_DATA_ENUM_TYPE input, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
	INMOST_DATA_INTEGER_TYPE AggregateMin(INMOST_DATA_INTEGER_TYPE input, INMOST_MPI_Comm comm = INMOST_MPI_COMM_WORLD);
