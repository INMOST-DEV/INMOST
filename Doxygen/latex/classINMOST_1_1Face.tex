...
Interface provides some operations that can be done uniquely on the object of class \hyperlink{classINMOST_1_1Element}{Element} for which Element\-::\-Get\-Element\-Type retruns F\-A\-C\-E.
...
You can obtain object of class \hyperlink{classINMOST_1_1Face}{Face} from Mesh\-::iterator\-Face, in this case obtained object is always valid. Also you can get it through Mesh\-::\-Face\-By\-Local\-I\-D, check with Element\-::is\-Valid to see whether you have obtained a valid object. You can convert an object of class \hyperlink{classINMOST_1_1Element}{Element} into an object of class \hyperlink{classINMOST_1_1Face}{Face} by Element\-::get\-As\-Face. In debug mode it will internally check that the element is of type F\-A\-C\-E. You may compose an object of class \hyperlink{classINMOST_1_1Face}{Face} by using constructor and specifing pointer to the mesh and providing element's handle. You can make a handle with Compose\-Handle(\-F\-A\-C\-E,local\-\_\-id) function. 
